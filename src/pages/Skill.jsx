    ...
    return (
        <>
            <div id={"skill"} className={`flex flex-col gap-4 justify-center items-center ${props.backConfig==="dark"?"white":"black"}`}>
                ...
                <div style={{padding:"1rem"}} className={`flex flex-col ${isMobile?"gap-2":"gap-6"} rounded-2xl border-[1px] border-amber-500`}>
                    <div className={`flex flex-col ${isMobile?"gap-1":"gap-4"} shadow-2xs`}>
                        <h3 className={`font-bold ${isMobile?"text-lg":"text-3xl"}`}>Front-End</h3>
                    ...
                    <div className={`flex flex-col ${isMobile?"gap-1":"gap-4"} shadow-2xs`}>
                        <h3 className={`font-bold ${isMobile?"text-lg":"text-3xl"}`}>Database</h3>
                        <div className={"grid grid-cols-[1fr_1fr_1fr_1fr] gap-2 skills"}>
                    ...
                    <div className={`flex flex-col ${isMobile?"gap-1":"gap-4"} shadow-2xs`}>
                        <h3 className={`font-bold ${isMobile?"text-lg":"text-3xl"}`}>Tools & Others</h3>
                        <div className={"grid grid-cols-[1fr_1fr_1fr_1fr] gap-2 skills"}>
